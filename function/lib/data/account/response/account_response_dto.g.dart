...
AccountResponseDto _$AccountResponseDtoFromJson(Map<String, dynamic> json) =>
    AccountResponseDto(
      ...
      grade: json['grade'] == null
          ? null
          : GradeResponseDto.fromJson(json['grade'] as Map<String, dynamic>),
      firstGrade: json['firstGrade'] == null
          ? null
          : GradeResponseDto.fromJson(
              json['firstGrade'] as Map<String, dynamic>),
      secondGrade: json['secondGrade'] == null
          ? null
          : GradeResponseDto.fromJson(
              json['secondGrade'] as Map<String, dynamic>),
      thirdGrade: json['thirdGrade'] == null
          ? null
          : GradeResponseDto.fromJson(
              json['thirdGrade'] as Map<String, dynamic>),
      fourthGrade: json['fourthGrade'] == null
          ? null
          : GradeResponseDto.fromJson(
              json['fourthGrade'] as Map<String, dynamic>),
      fifthGrade: json['fifthGrade'] == null
          ? null
          : GradeResponseDto.fromJson(
              json['fifthGrade'] as Map<String, dynamic>),
      ...
      xCoordinate: json['xCoordinate'] as String?,
      yCoordinate: json['yCoordinate'] as String?,
    );
